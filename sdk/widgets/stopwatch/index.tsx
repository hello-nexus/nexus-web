// Stopwatch — first dogfood conversion of a marketplace widget to the SDK.
//
// Compare this to nexus-widgets/widgets/com.hellonexus.stopwatch/manifest.json:
// ~120 lines of declarative JSON + a binding mini-language (now(), formatDuration,
// conditional, localUpdate) collapse into real, readable React. Same behaviour,
// same look — the host renders @hellonexus/ui into the identical panel cell.
