...
const SETTINGS_ITEMS: { tab: string; tabLabelKey: string; labelKey: string; anchor: string; keywords: string[]; platforms?: string[]; official?: boolean }[] = [
  ...
  { tab: 'general', tabLabelKey: 'settings.general', labelKey: 'focus.title',                   anchor: 'set-focus',      keywords: ['focus', 'focus mode', 'game mode', 'gaming', 'streaming', 'do not disturb', 'quiet'] },
