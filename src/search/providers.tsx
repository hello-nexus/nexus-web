...
const SETTINGS_ITEMS: { tab: string; tabLabelKey: string; labelKey: string; anchor: string; keywords: string[]; platforms?: string[]; official?: boolean }[] = [
  ...
  { tab: 'general', tabLabelKey: 'settings.general', labelKey: 'gameMode.displaysOff.label',     anchor: 'set-game-mode-displays', keywords: ['game mode', 'panel', 'display', 'screen off', 'sleep', 'y70', 'render', 'performance'] },
