...
const SETTINGS_ITEMS: { tab: string; tabLabelKey: string; labelKey: string; anchor: string; keywords: string[]; platforms?: string[] }[] = [
  ...
  { tab: 'monitoring', tabLabelKey: 'settings.tab.monitoring', labelKey: 'lighting.sleepBlackout.label', anchor: 'set-sleep-blackout', keywords: ['sleep', 'suspend', 'standby', 'leds', 'lights', 'off', 'ram', 'memory'], platforms: ['windows'] },
