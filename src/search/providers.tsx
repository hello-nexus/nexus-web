...
const SETTINGS_ITEMS: { tab: string; tabLabelKey: string; labelKey: string; anchor: string; keywords: string[]; platforms?: string[]; official?: boolean }[] = [
  ...
  { tab: 'general', tabLabelKey: 'settings.general', labelKey: 'gameMode.state.label',          anchor: 'set-game-mode',  keywords: ['game mode', 'gaming', 'game', 'do not disturb', 'focus', 'quiet'] },
  { tab: 'general', tabLabelKey: 'settings.general', labelKey: 'gameMode.holdNotifications.label', anchor: 'set-game-mode-notifications', keywords: ['game mode', 'notifications', 'alerts', 'silence', 'mute', 'do not disturb'] },
  { tab: 'general', tabLabelKey: 'settings.general', labelKey: 'gameMode.holdNetwork.label',     anchor: 'set-game-mode-network', keywords: ['game mode', 'uploads', 'telemetry', 'network', 'cloud', 'updates', 'bandwidth'] },
  { tab: 'general', tabLabelKey: 'settings.general', labelKey: 'gameMode.displaysOff.label',     anchor: 'set-game-mode-displays', keywords: ['game mode', 'panel', 'display', 'screen off', 'sleep', 'y70'] },
  { tab: 'general', tabLabelKey: 'settings.general', labelKey: 'gameMode.renderStop.label',      anchor: 'set-game-mode-rendering', keywords: ['game mode', 'panel', 'render', 'rendering', 'performance', 'cpu', 'gpu'] },
