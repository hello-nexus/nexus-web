...
export const EFFECTS: EffectDef[] = [
  ...
  { key: 'beatbuilder', labelKey: 'lighting.controls.beatbuilder', audio: true, params: [
      ...
      { name: 'u_hue2',       labelKey: 'lighting.controls.bb.hue2',       label: 'Second Hue',        min: 0,    max: 1,   step: 0.01,  defaultValue: 0.5 },
      ...
      { name: 'u_corner',     labelKey: 'lighting.controls.bb.corner',     label: 'Rounded Corners',   min: 0,    max: 1,   step: 0.05,  defaultValue: 0 },
