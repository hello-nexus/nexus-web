...
import { GAUGE_DESIGN_KEYS, GAUGE_DESIGN_LABELS } from '../performance/gauges';
import { DESIGN_ICONS } from '../performance/gauges/DesignIcons';
import type { GaugeDesignKey } from '../performance/gauges';
import {
  DEFAULT_SLOTS,
  isMicroLayout,
  resolvedSlotCountForSize,
} from '../performance/perfSlots';
import type { DeviceKey } from '../performance/perfSlots';
import { buildNetworkSensors, networkSensorOptions, NETWORK_SENSOR_TOTAL } from '../performance/networkSensors';
import { bareSensorLabel } from '../performance/sensorNames';
import { DEFAULT_SCALE_MODE, designSupportsScale, type ScaleMode } from '../performance/perfDomain';
import styles from './PerformanceSettings.module.scss';
